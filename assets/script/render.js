...
let engineerBox = addEmpbox();
engineerWindow.append(engineerBox);

let internBox = addEmpbox();
internWindow.append(internBox);





//prepare box template

////span.innerText = 'manager';
//div.append(span);
//div.setAttribute('class', 'container box is-one-fifth');
//managerWindow.appendChild(div);

//managerWindow.append('div');
//managerWindow.append('div');
//managerWindow.append('div');
//managerWindow.append('div');
